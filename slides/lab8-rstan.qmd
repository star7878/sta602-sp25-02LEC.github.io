...
In statistical terms, your outcome $Y$ is the type of the email (spam or not) and you have each of the 57 predictors in $x$. $x$ includes the frequency of certain words, the occurrence of certain symbols and the use of capital letters in each email.
...
#| echo: false
#| eval: false
fit3 = stan_glm(type ~ ., data = spam_train,
