...
5. An example of plotting a function with `ggplot` (loaded via the `tidyverse` package.)
...
Using the code above as a template, plot the density of an exponential (use `dexp`), this is useful on homework 1. 
