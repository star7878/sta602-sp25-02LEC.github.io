...
a. Write down a data generative model (or two) that describe this data.

b. Write down your prior beliefs about unknown parameters in your model above using a conjugate density.

c. Report (using Monte Carlo sampling other otherwise) the posterior [relative risk](https://en.wikipedia.org/wiki/Relative_risk), i.e. the posterior probability of stroke in the treatment group versus in the control. Additionally, include a 95% posterior confidence interval for the relative risk.
